...
pub struct AdvancedGlobalTaskListenerEventTypeFilter {
    /// Checks for equality with the provided value.
    #[serde(rename = "$eq", skip_serializing_if = "Option::is_none")]
    pub dollar_eq: Option<models::GlobalTaskListenerEventTypeEnum>,
    /// Checks for inequality with the provided value.
    #[serde(rename = "$neq", skip_serializing_if = "Option::is_none")]
    pub dollar_neq: Option<models::GlobalTaskListenerEventTypeEnum>,
    /// Checks if the current property exists.
    #[serde(rename = "$exists", skip_serializing_if = "Option::is_none")]
    pub dollar_exists: Option<bool>,
    /// Checks if the property matches any of the provided values.
    #[serde(rename = "$in", skip_serializing_if = "Option::is_none")]
    pub dollar_in: Option<Vec<models::GlobalTaskListenerEventTypeEnum>>,
...
impl AdvancedGlobalTaskListenerEventTypeFilter {
    /// Advanced global listener event type filter.
    pub fn new() -> AdvancedGlobalTaskListenerEventTypeFilter {
