...
impl AdvancedDecisionInstanceStateFilter {
    /// Advanced DecisionInstanceStateEnum filter.
    pub fn new() -> AdvancedDecisionInstanceStateFilter {
