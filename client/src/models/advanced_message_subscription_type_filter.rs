...
impl AdvancedMessageSubscriptionTypeFilter {
    /// Advanced MessageSubscriptionTypeEnum filter
    pub fn new() -> AdvancedMessageSubscriptionTypeFilter {
