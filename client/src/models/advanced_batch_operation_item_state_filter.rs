...
impl AdvancedBatchOperationItemStateFilter {
    /// Advanced BatchOperationItemStateEnum filter.
    pub fn new() -> AdvancedBatchOperationItemStateFilter {
