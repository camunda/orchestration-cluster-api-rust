...
/// ElementInstanceFilter : Element instance search filter.
...
pub struct ElementInstanceFilter {
    ...
    pub element_instance_scope_key: Option<String>,
    ...
    pub dollar_or: Option<Vec<models::ElementInstanceFilterFields>>,
}

impl ElementInstanceFilter {
    /// Element instance search filter.
    pub fn new() -> ElementInstanceFilter {
