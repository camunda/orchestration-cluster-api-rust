...
impl AdvancedMessageSubscriptionStateFilter {
    /// Advanced MessageSubscriptionStateEnum filter
    pub fn new() -> AdvancedMessageSubscriptionStateFilter {
