...
pub struct GlobalTaskListenerResult {
    ...
    pub id: String,
    #[serde(rename = "source")]
    pub source: models::GlobalListenerSourceEnum,
}

impl GlobalTaskListenerResult {
    pub fn new(id: String, source: models::GlobalListenerSourceEnum) -> GlobalTaskListenerResult {
