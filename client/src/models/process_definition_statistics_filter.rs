...
pub struct ProcessDefinitionStatisticsFilter {
    /// The start date.
    ...
    pub dollar_or: Option<Vec<models::BaseProcessInstanceFilterFields>>,
}

impl ProcessDefinitionStatisticsFilter {
    /// Process definition statistics search filter.
    pub fn new() -> ProcessDefinitionStatisticsFilter {
