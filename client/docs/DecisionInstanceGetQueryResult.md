...
**evaluated_inputs** | [**Vec<models::EvaluatedDecisionInputItem>**](EvaluatedDecisionInputItem.md) | The evaluated inputs of the decision instance.  | 
**matched_rules** | [**Vec<models::MatchedDecisionRuleItem>**](MatchedDecisionRuleItem.md) | The matched rules of the decision instance.  | 
