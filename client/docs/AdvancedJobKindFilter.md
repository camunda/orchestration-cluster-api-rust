...
------------ | ------------- | ------------- | -------------
**dollar_eq** | Option<[**models::JobKindEnum**](JobKindEnum.md)> | Checks for equality with the provided value. | [optional]
**dollar_neq** | Option<[**models::JobKindEnum**](JobKindEnum.md)> | Checks for inequality with the provided value. | [optional]
**dollar_exists** | Option<**bool**> | Checks if the current property exists. | [optional]
**dollar_in** | Option<[**Vec<models::JobKindEnum>**](JobKindEnum.md)> | Checks if the property matches any of the provided values. | [optional]
