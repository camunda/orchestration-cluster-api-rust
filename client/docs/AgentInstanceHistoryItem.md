...
**metrics** | Option<[**models::AgentInstanceHistoryItemMetricsRequest**](AgentInstanceHistoryItemMetricsRequest.md)> | Per-call token and latency metrics. Present on ASSISTANT items only. | [optional]
