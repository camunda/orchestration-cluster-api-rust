...
------------ | ------------- | ------------- | -------------
**dollar_eq** | Option<[**models::JobStateEnum**](JobStateEnum.md)> | Checks for equality with the provided value. | [optional]
**dollar_neq** | Option<[**models::JobStateEnum**](JobStateEnum.md)> | Checks for inequality with the provided value. | [optional]
**dollar_exists** | Option<**bool**> | Checks if the current property exists. | [optional]
**dollar_in** | Option<[**Vec<models::JobStateEnum>**](JobStateEnum.md)> | Checks if the property matches any of the provided values. | [optional]
