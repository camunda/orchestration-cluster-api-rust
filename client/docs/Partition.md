...
**state** | **State** | Describes the current operational state of the partition within the cluster configuration.  (enum: unknown, joining, active, leaving, recovering, learner) | 
