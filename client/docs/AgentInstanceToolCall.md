...
**arguments** | Option<**std::collections::HashMap<String, serde_json::Value>**> | The tool call arguments as provided by the LLM. May be null or populated on any item, including TOOL_RESULT.  | 
