...
[**search_process_definition_variable_names**](ProcessDefinitionApi.md#search_process_definition_variable_names) | **POST** /process-definitions/{processDefinitionKey}/variable-names/search | Search process definition variable names
...
> models::ProcessDefinitionVariableNameSearchQueryResult search_process_definition_variable_names(process_definition_key, process_definition_variable_name_search_query)
...
------------- | ------------- | ------------- | ------------- | -------------
**process_definition_key** | **ProcessDefinitionKey** | The assigned key of the process definition, which acts as a unique identifier for this process definition. | [required] |
**process_definition_variable_name_search_query** | Option<[**ProcessDefinitionVariableNameSearchQuery**](ProcessDefinitionVariableNameSearchQuery.md)> |  |  |

### Return type

[**models::ProcessDefinitionVariableNameSearchQueryResult**](ProcessDefinitionVariableNameSearchQueryResult.md)
