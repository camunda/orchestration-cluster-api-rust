...
**event_types** | Option<[**Vec<models::GlobalTaskListenerEventTypeEnum>**](GlobalTaskListenerEventTypeEnum.md)> | List of user task event types that trigger the listener. | [optional]
**id** | **String** | The user-defined id for the global listener | 
**source** | [**models::GlobalListenerSourceEnum**](GlobalListenerSourceEnum.md) |  | 
