...
**operations** | [**Vec<models::ClusterModeChangeOperation>**](ClusterModeChangeOperation.md) | The ordered list of operations that will be applied to the physical tenant. | 
